...
object FunctionWithVariableArguments_Tutorial extends App {
  ...
  // As a variable argument, you will be allowed to call the printReport() function
  // by passing zero or many parameters of type String as shown in Step 2 below.
  ...
  // printReport(listDonuts) compiler error
